...
test('Semgrep records the V1 source bundle but remains disabled pending release qualification', async () => {
  ...
  assert.equal(sha256(lockBytes), '8fb3262de39d9c0c9c3b1e0c1010543ed071676e95e2d0be544c0c7fc998b2c8');
  ...
  assert.equal(bundleEvidence.bundle.sha256, '8f3433f6eaed5dfd810a0cb1355686feaf241efb3e3f792cd6faa7ca093c3559');
  ...
  assert.equal(bundleEvidence.sourceLockSha256, '8fb3262de39d9c0c9c3b1e0c1010543ed071676e95e2d0be544c0c7fc998b2c8');
