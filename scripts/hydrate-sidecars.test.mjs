...
test('Semgrep records the V1 source bundle but remains disabled pending release qualification', async () => {
  ...
  assert.equal(sha256(lockBytes), '9559e4700fef3c97246b0b40c2ac158400c4e1d26be0eae68d864d02f5891bd8');
  ...
  assert.equal(bundleEvidence.bundle.sha256, '0142bd8aa73308e7a7350328e0c34537201e09a0b5554ba7a6307fa6d89f619e');
  ...
  assert.equal(bundleEvidence.sourceLockSha256, '9559e4700fef3c97246b0b40c2ac158400c4e1d26be0eae68d864d02f5891bd8');
