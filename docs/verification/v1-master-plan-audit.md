...
| T03 | Establish the pinned Rust/Tauri workspace and fully pinned CI. | [PR #12 stabilization ledger](pr-12-stabilization.md), [CI workflow](../../.github/workflows/ci.yml), [independent-gate contract](../../scripts/ci-gates-workflow.test.mjs), [A-004 feature-scope amendment](../protocols/contract-amendments.md), [workspace manifest](../../Cargo.toml), [Tasks 1–10 ledger](tasks-1-10.md) | partial | Run every independent gate remotely on Windows x64 and macOS arm64, then clear all remaining public CI failures without skipped required checks. |
