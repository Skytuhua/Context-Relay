...
| T02 | Add Apache-2.0 licensing and public-repository governance. | [LICENSE](../../LICENSE), [notices](../../THIRD_PARTY_NOTICES.md), [security policy](../../SECURITY.md), [Tasks 1–10 ledger](tasks-1-10.md) | partial | Verify GitHub license detection, push protection, branch/tag protection, fork-secret isolation, and name clearance live. |
| T03 | Establish the pinned Rust/Tauri workspace and fully pinned CI. | [CI workflow](../../.github/workflows/ci.yml), [workspace manifest](../../Cargo.toml), [Tasks 1–10 ledger](tasks-1-10.md) | partial | Clear strict Rust lint, Windows portability, Supabase action pinning, secret-scan, and all remaining public CI failures. |
| T04 | Freeze protocol v1 and the threat model. | [Protocol 1.3](../protocols/protocol-v1.md), [canonical CBOR](../protocols/cbor-v1.md), [threat model](../security/threat-model.md), [amendments](../protocols/contract-amendments.md) | amended | Ratify all three amendments together and rerun cross-platform protocol/binding fixtures. |
...
| T11 | Implement the Codex adapter. | [capability contract](../../adapters/codex/capabilities.md), [adapter tests](../../crates/core/tests/codex_adapter_v1.rs) | implemented-unverified | Create an authoritative ledger and run real current/previous/unknown, wrapper, precedence, and rollback fixtures on both OSes. |
| T12 | Implement the Hermes adapter. | [capability contract](../../adapters/hermes/capabilities.md), [adapter tests](../../crates/core/tests/hermes_adapter_v1.rs) | implemented-unverified | Create an authoritative ledger and run real profile, gateway, secret-redaction, permission-loss, and rollback fixtures on both OSes. |
| T13 | Expose scoped MCP memory, tasks, and handoffs. | [MCP server](../../crates/context-mcp/src/server.rs), [MCP end-to-end tests](../../crates/context-mcp/tests/end_to_end_v1.rs) | implemented-unverified | Publish a dedicated ledger covering every v1 tool, stdout purity, replay, permission denial, restart, and backpressure. |
...
| RB-REP | Release blockers: repository and licensing. | [Tasks 1–10 ledger](tasks-1-10.md), [notices](../../THIRD_PARTY_NOTICES.md), [repository settings](../repository-settings.md) | partial | Verify every license, fork-secret, `main`, and `v*` protection gate live; resolve current public CI/security alerts. |
