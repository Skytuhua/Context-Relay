...
work. `VaultConfig::new` still selects `UnavailableAccountLifecycleTransport`,
and production startup does not replace it. These source findings preserve the
