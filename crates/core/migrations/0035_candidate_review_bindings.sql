ALTER TABLE local_operation_results RENAME TO local_operation_results_v34;
ALTER TABLE local_operation_bindings RENAME TO local_operation_bindings_v34;
...
FROM local_operation_bindings_v34;

INSERT INTO local_operation_results(operation_id, canonical_response)
SELECT operation_id, canonical_response
FROM local_operation_results_v34;

DROP TABLE local_operation_results_v34;
DROP TABLE local_operation_bindings_v34;
