CREATE TABLE recovery_enrollments_clock_domains (
    ...
    CHECK (
        ...
        (state = 'active'
            ...
            AND provider_accepted_at_ms IS NOT NULL
...
INSERT INTO recovery_enrollments_clock_domains SELECT * FROM recovery_enrollments;
DROP TABLE recovery_enrollments;
ALTER TABLE recovery_enrollments_clock_domains RENAME TO recovery_enrollments;
