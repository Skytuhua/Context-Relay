CREATE TABLE recovery_restores_clock_domains (
...
INSERT INTO recovery_restores_clock_domains SELECT * FROM recovery_restores;
DROP TABLE recovery_restores;
ALTER TABLE recovery_restores_clock_domains RENAME TO recovery_restores;
