...
#[test]
fn exact_local_wire_versions_do_not_negotiate_across_atomic_project_registration() {
    let legacy = ProtocolVersionRange {
        min: ProtocolVersion { major: 1, minor: 4 },
    ...
    assert_eq!(PROTOCOL_VERSION, ProtocolVersion { major: 1, minor: 5 });
